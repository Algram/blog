...
export enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___keywords = 'childMarkdownRemark___frontmatter___keywords',
  childMarkdownRemark___frontmatter___layout = 'childMarkdownRemark___frontmatter___layout',
  childMarkdownRemark___frontmatter___hero___birthtime = 'childMarkdownRemark___frontmatter___hero___birthtime',
  childMarkdownRemark___frontmatter___hero___birthtimeMs = 'childMarkdownRemark___frontmatter___hero___birthtimeMs',
  childMarkdownRemark___frontmatter___hero___sourceInstanceName = 'childMarkdownRemark___frontmatter___hero___sourceInstanceName',
  childMarkdownRemark___frontmatter___hero___absolutePath = 'childMarkdownRemark___frontmatter___hero___absolutePath',
  childMarkdownRemark___frontmatter___hero___relativePath = 'childMarkdownRemark___frontmatter___hero___relativePath',
  childMarkdownRemark___frontmatter___hero___extension = 'childMarkdownRemark___frontmatter___hero___extension',
  childMarkdownRemark___frontmatter___hero___size = 'childMarkdownRemark___frontmatter___hero___size',
  childMarkdownRemark___frontmatter___hero___prettySize = 'childMarkdownRemark___frontmatter___hero___prettySize',
  childMarkdownRemark___frontmatter___hero___modifiedTime = 'childMarkdownRemark___frontmatter___hero___modifiedTime',
  childMarkdownRemark___frontmatter___hero___accessTime = 'childMarkdownRemark___frontmatter___hero___accessTime',
  childMarkdownRemark___frontmatter___hero___changeTime = 'childMarkdownRemark___frontmatter___hero___changeTime',
  childMarkdownRemark___frontmatter___hero___birthTime = 'childMarkdownRemark___frontmatter___hero___birthTime',
  childMarkdownRemark___frontmatter___hero___root = 'childMarkdownRemark___frontmatter___hero___root',
  childMarkdownRemark___frontmatter___hero___dir = 'childMarkdownRemark___frontmatter___hero___dir',
  childMarkdownRemark___frontmatter___hero___base = 'childMarkdownRemark___frontmatter___hero___base',
  childMarkdownRemark___frontmatter___hero___ext = 'childMarkdownRemark___frontmatter___hero___ext',
  childMarkdownRemark___frontmatter___hero___name = 'childMarkdownRemark___frontmatter___hero___name',
  childMarkdownRemark___frontmatter___hero___relativeDirectory = 'childMarkdownRemark___frontmatter___hero___relativeDirectory',
  childMarkdownRemark___frontmatter___hero___dev = 'childMarkdownRemark___frontmatter___hero___dev',
  childMarkdownRemark___frontmatter___hero___mode = 'childMarkdownRemark___frontmatter___hero___mode',
  childMarkdownRemark___frontmatter___hero___nlink = 'childMarkdownRemark___frontmatter___hero___nlink',
  childMarkdownRemark___frontmatter___hero___uid = 'childMarkdownRemark___frontmatter___hero___uid',
  childMarkdownRemark___frontmatter___hero___gid = 'childMarkdownRemark___frontmatter___hero___gid',
  childMarkdownRemark___frontmatter___hero___rdev = 'childMarkdownRemark___frontmatter___hero___rdev',
  childMarkdownRemark___frontmatter___hero___blksize = 'childMarkdownRemark___frontmatter___hero___blksize',
  childMarkdownRemark___frontmatter___hero___ino = 'childMarkdownRemark___frontmatter___hero___ino',
  childMarkdownRemark___frontmatter___hero___blocks = 'childMarkdownRemark___frontmatter___hero___blocks',
  childMarkdownRemark___frontmatter___hero___atimeMs = 'childMarkdownRemark___frontmatter___hero___atimeMs',
  childMarkdownRemark___frontmatter___hero___mtimeMs = 'childMarkdownRemark___frontmatter___hero___mtimeMs',
  childMarkdownRemark___frontmatter___hero___ctimeMs = 'childMarkdownRemark___frontmatter___hero___ctimeMs',
  childMarkdownRemark___frontmatter___hero___atime = 'childMarkdownRemark___frontmatter___hero___atime',
  childMarkdownRemark___frontmatter___hero___mtime = 'childMarkdownRemark___frontmatter___hero___mtime',
  childMarkdownRemark___frontmatter___hero___ctime = 'childMarkdownRemark___frontmatter___hero___ctime',
  childMarkdownRemark___frontmatter___hero___publicURL = 'childMarkdownRemark___frontmatter___hero___publicURL',
  childMarkdownRemark___frontmatter___hero___id = 'childMarkdownRemark___frontmatter___hero___id',
  childMarkdownRemark___frontmatter___hero___children = 'childMarkdownRemark___frontmatter___hero___children',
  childMarkdownRemark___frontmatter___readNext = 'childMarkdownRemark___frontmatter___readNext',
  childMarkdownRemark___frontmatter___pinned = 'childMarkdownRemark___frontmatter___pinned',
  childMarkdownRemark___frontmatter___githubIssue = 'childMarkdownRemark___frontmatter___githubIssue',
...
export enum MarkdownRemarkFieldsEnum {
  ...
  frontmatter___hero___childMarkdownRemark___id = 'frontmatter___hero___childMarkdownRemark___id',
  frontmatter___hero___childMarkdownRemark___excerpt = 'frontmatter___hero___childMarkdownRemark___excerpt',
  frontmatter___hero___childMarkdownRemark___rawMarkdownBody = 'frontmatter___hero___childMarkdownRemark___rawMarkdownBody',
  frontmatter___hero___childMarkdownRemark___fileAbsolutePath = 'frontmatter___hero___childMarkdownRemark___fileAbsolutePath',
  frontmatter___hero___childMarkdownRemark___html = 'frontmatter___hero___childMarkdownRemark___html',
  frontmatter___hero___childMarkdownRemark___htmlAst = 'frontmatter___hero___childMarkdownRemark___htmlAst',
  frontmatter___hero___childMarkdownRemark___excerptAst = 'frontmatter___hero___childMarkdownRemark___excerptAst',
  frontmatter___hero___childMarkdownRemark___headings = 'frontmatter___hero___childMarkdownRemark___headings',
  frontmatter___hero___childMarkdownRemark___timeToRead = 'frontmatter___hero___childMarkdownRemark___timeToRead',
  frontmatter___hero___childMarkdownRemark___tableOfContents = 'frontmatter___hero___childMarkdownRemark___tableOfContents',
  frontmatter___hero___childMarkdownRemark___children = 'frontmatter___hero___childMarkdownRemark___children',
  ...
  frontmatter___readNext = 'frontmatter___readNext',
  frontmatter___pinned = 'frontmatter___pinned',
  frontmatter___githubIssue = 'frontmatter___githubIssue',
  excerpt = 'excerpt',
...
export type MarkdownRemarkFrontmatter = {
  ...
  githubIssue?: Maybe<Scalars['String']>,
};
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  githubIssue?: Maybe<StringQueryOperatorInput>,
};
...
export enum SitePageFieldsEnum {
  ...
  context___next___timeToRead = 'context___next___timeToRead',
  context___next___frontmatter___date = 'context___next___frontmatter___date',
  context___next___frontmatter___path = 'context___next___frontmatter___path',
  context___next___frontmatter___category = 'context___next___frontmatter___category',
  context___next___frontmatter___keywords = 'context___next___frontmatter___keywords',
  context___next___frontmatter___title = 'context___next___frontmatter___title',
  context___next___frontmatter___githubIssue = 'context___next___frontmatter___githubIssue',
...
export type HomeQuery = (
  ...
  & { site: Maybe<(
    ...
    & { siteMetadata: Maybe<(
      ...
      & { author: Maybe<(
        { __typename?: 'SiteSiteMetadataAuthor' }
        & Pick<SiteSiteMetadataAuthor, 'name' | 'email'>
      )> }
    )> }
  )>, allMarkdownRemark: (
    { __typename?: 'MarkdownRemarkConnection' }
    & { edges: Array<(
      ...
      & { node: (
        ...
        & { frontmatter: Maybe<(
          { __typename?: 'MarkdownRemarkFrontmatter' }
          & Pick<MarkdownRemarkFrontmatter, 'layout' | 'path' | 'date' | 'category' | 'title' | 'pinned'>
          & { hero: Maybe<(
            { __typename?: 'File' }
